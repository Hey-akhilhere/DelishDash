...
const Header = () =>{
    return(
        <div className="header">
            <img className="logo" src="https://assets.zenn.com/strapi_assets/medium_Fast_food_logos_18461bbf59.png"/>
...
const Restaurant= (props) =>{
    ...
    return (
        <div className="restaurantcards">
            <img className="card-img"src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_600/" +props.resData.data.cloudinaryImageId}/>
            <h3>{props.resData.data.name}</h3>
            <h3>{props.resData.data.cuisines.join(" , ")}</h3>
            <h3>{props.resData.data.deliveryTime} Minutes</h3>
